    ...
    return (
        <div>
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                ...
                {(isLandlord || isManager) && <Button onClick={() => setShowCreateModal(true)}>+ Add Ticket</Button>}
                {isTenant && hasActiveLease && <Button onClick={() => setShowCreateModal(true)}>+ Add Ticket</Button>}
            </div>
                ...
                {isLoading ? (
                    ...
                    <>
                        ...
                        <div className="lg:hidden divide-y divide-gray-50">
                            {tickets.map((ticket) => (
                                <div key={ticket.id} className="p-4 hover:bg-gray-50/50 transition">
