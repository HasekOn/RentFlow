    ...
    return (
        <div>
            ...
            <div className="flex items-center justify-between">
                <h1 className="text-4xl font-bold text-black">Helpdesk</h1>
                {(isLandlord || isTenant) && (
            ...
            <div className="bg-white rounded-2xl shadow-sm mt-6">
                <div className="p-4 border-b border-gray-100 flex items-center gap-4 flex-wrap">
                    ...
                    <input
                        ...
                        className="px-4 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-black/10 w-56"
                    />
                    <select
                        value={statusFilter}
                                ...
                                <tr key={ticket.id} className="border-b border-gray-50 hover:bg-gray-50/50 transition">
                                    ...
                                    <td className="px-4 py-4">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <span className="text-sm text-gray-600">{ticket.tenant?.name || '—'}</span>
                                        </div>
                                    </td>
                                    <td className="px-6 py-4">
